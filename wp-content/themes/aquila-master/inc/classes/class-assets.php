...
class Assets {
	...
	public function register_styles() {
		...
		wp_register_style( 'animate-css', AQUILA_BUILD_LIB_URI . '/css/animate.css', [], false, 'all' );
		wp_register_style( 'owl-carousel-css', AQUILA_BUILD_LIB_URI . '/css/owl.carousel.css', [], false, 'all' );
		wp_register_style( 'style-css', AQUILA_BUILD_CSS_URI . '/style.css', [], filemtime( AQUILA_BUILD_CSS_DIR_PATH . '/style.css' ), 'all' );
		wp_register_style( 'style-css', AQUILA_BUILD_CSS_URI . '/style.css', [], filemtime( AQUILA_BUILD_CSS_DIR_PATH . '/style.css' ), 'all' );
		wp_register_style( 'swiper-css', AQUILA_BUILD_CSS_URI . '/swiper-bundle.min.css', [], filemtime( AQUILA_BUILD_CSS_DIR_PATH . '/swiper-bundle.min.css' ), 'all' );
